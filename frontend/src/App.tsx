...
const DossiersExamen = lazyWithRetry(() => import('./pages/DossiersExamen'))
const RemboursementTransport = lazyWithRetry(() => import('./pages/RemboursementTransport'))
const Validation = lazyWithRetry(() => import('./pages/Validation'))
const RequisitionDetail = lazyWithRetry(() => import('./pages/RequisitionDetail'))
const SortiesFonds = lazyWithRetry(() => import('./pages/SortiesFonds'))
const Rapports = lazyWithRetry(() => import('./pages/Rapports'))
const RequisitionPdfSmart = lazyWithRetry(() => import('./pages/RequisitionPdfSmart'))
const AuditLogs = lazyWithRetry(() => import('./pages/AuditLogs'))
const ClotureCaisse = lazyWithRetry(() => import('./pages/ClotureCaisse'))
const Denominations = lazyWithRetry(() => import('./pages/Denominations'))
...
const AuditSortie = lazyWithRetry(() => import('./pages/AuditSortie'))
const OrganisationSettings = lazyWithRetry(() => import('./pages/OrganisationSettings'))
const SuperAdmin = lazyWithRetry(() => import('./pages/SuperAdmin'))
const AIProvidersPage = lazyWithRetry(() => import('./pages/AIProvidersPage'))
const AdminAccessDenied = lazyWithRetry(() => import('./pages/AdminAccessDenied'))
const GlobalMonitoring = lazyWithRetry(() => import('./pages/GlobalMonitoring'))
const Signup = lazyWithRetry(() => import('./pages/Signup'))
const Checkout = lazyWithRetry(() => import('./pages/Checkout'))
const HRModule = lazyWithRetry(() => import('./pages/HRModule'))
const SecretariatDashboardPage = lazyWithRetry(() => import('./pages/SecretariatDashboardPage'))
const AgentCourrierPage = lazyWithRetry(() => import('./pages/AgentCourrierPage'))
const AgentReunionPage = lazyWithRetry(() => import('./pages/AgentReunionPage'))
const AgentAgendaPage = lazyWithRetry(() => import('./pages/AgentAgendaPage'))
const AgentDocumentsPage = lazyWithRetry(() => import('./pages/AgentDocumentsPage'))
const AgentManagerPage = lazyWithRetry(() => import('./pages/AgentManagerPage'))
const SecretariatApprovalsPage = lazyWithRetry(() => import('./pages/SecretariatApprovalsPage'))
const SecretariatSettingsPage = lazyWithRetry(() => import('./pages/SecretariatSettingsPage'))
const TableauModulePage = lazyWithRetry(() => import('./pages/TableauModulePage'))
const Comptabilite = lazyWithRetry(() => import('./pages/Comptabilite'))
