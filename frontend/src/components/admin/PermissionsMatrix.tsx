...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  'rh.attendance.export': 'Exporter les présences',
  'rh.attendance.correct': 'Corriger les pointages',
...
const HR_ORDER = [
  ...
  'rh.attendance.view', 'rh.attendance.manage', 'rh.attendance.export', 'rh.attendance.correct',
