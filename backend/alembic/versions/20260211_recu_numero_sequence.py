"""add receipt sequence generator

Revision ID: 20260211_recu_numero_sequence
Revises: 20260211_permissions_fr
Create Date: 2026-02-11
"""

from alembic import op

revision = "20260211_recu_numero_sequence"
down_revision = "20260211_permissions_fr"
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    ...
    op.execute("DROP FUNCTION IF EXISTS generate_recu_numero();")
