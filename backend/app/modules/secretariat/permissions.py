...
# Le Tableau est devenu un module autonome : ses droits vivent désormais dans
# app/modules/tableau/permissions.py, sous le préfixe « tableau. ».
